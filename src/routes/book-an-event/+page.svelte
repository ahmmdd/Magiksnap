...
<svelte:head>
  ...
  <meta name="description" content="Book your Photobooth Event now">
  <meta name="keywords" content="Book your photobooth Event Toronto, Photobooth, Photobooth Rentals, Events, Toronto, Missasauga, Oakville, Kitchner">
</svelte:head>
<div class="wrapper flex full-page-height">
  <h1>Book an Event</h1>
    <p>Book your photobooth event now by filling in the form below and our team will get back to you.</p>
